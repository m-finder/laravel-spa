<template>
    <section class="content container-fluid">
            ...
            <div class="col-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title mb-0">权限列表</h3>
                    </div>
                    <div class="card-body">
                        <div class="card-tools mb-3">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group input-group-sm">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">权限名</span>
                                                </div>
                                                <b-form-input type="text" v-model="form.name" placeholder="输入权限名"/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group input-group-sm">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">权限别名</span>
                                                </div>
                                                <b-form-input type="text" v-model="form.alias" placeholder="输入权限别名"/>
                            ...
                            <div class="btn-group mr-3">
                                <b-button to="/permission/create" class="btn-sm" variant="primary">添加权限</b-button>
                            </div>
                        </div>
                        ...
                        <b-table striped hover :items="items" :fields="fields" :sort-by.sync="sortBy"
                            ...
                            <template v-slot:cell(actions)="row">
                                ...
                                <b-button variant="link" :to="'/permission/edit/' + row.item.id">编辑</b-button>
                            </template>
                        </b-table>
        ...
        <b-modal centered id="modal-permission-delete" title="操作提醒" @hidden="resetModal">
            <p class="my-4">
                {{ name ? '是否确认删除权限 ' + name + '？' : '是否删除该权限？'}}
            </p>
    ...
    export default {
        ...
        methods: {
            ...
            openDeleteModal(data) {
                this.name = data.name;
                this.id = data.id;
                this.$root.$emit('bv::show::modal', 'modal-permission-delete')
            },
            sure() {
                this.$bvModal.hide('modal-permission-delete')
